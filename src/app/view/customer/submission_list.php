...
<div class="row">
		<div class="pull-left"> 
			<h2>Project Submissions (<?php echo $this->tempVars['ProjectNAME'][0]->project_name; ?>)</h2>
		</div>
	</div>
	<div class="row"><div class="clear">&nbsp;</div><hr></div>	 
	<a class="btn btn-success" style="float:right; margin:10px 0px" href="<?php echo $this->buildUrl('customer/view-projects'); ?>"><span class="glyphicon glyphicon-list "></span> Project List</a> 
	<div class="row">		
		<?php 
		echo $_SESSION['MSG'];
