...
<div class="container">
	...
	<?php
	if($_SESSION["SESS_USER_ROLE"] == "General Manager")
	{
	?>
	<div class="row">
		<div class="col-md-10">
	...
	<div class="row">
		<div class="col-md-10">
			<div class="form-group">   
				...
				?>
				<p>
					<a class="fancybox" href="<?php echo SITE_URL."/media/submissionfile/".$this->tempVars['SubmissionList'][0]->submission_image;?>" data-fancybox-group="gallery"> 
						<img src='<?php echo SITE_URL."/media/submissionfile/".$this->tempVars['SubmissionList'][0]->submission_image;?>'  width="100px" /> 
					</a>
				</p>
				<?php 
	 ...
	 <div class="row">
		<div class="col-md-10">
			<div class="form-group">
				<label for="customer_name">Comments </label>
				<p>
					<?php echo nl2br($this->tempVars['SubmissionList'][0]->submission_comments); ?> 
				</p>	
			</div>
			<div><hr/></div>
			<table width="100%">
				<tr>
					<td>
						<strong>Focus:</strong> &nbsp;
						<?php if($this->tempVars['SubmissionList'][0]->submission_focus !='0')
						{
							echo $this->tempVars['SubmissionList'][0]->submission_focus; 
						}
						?>
					</td>
					<td>
						<strong>Creativity:</strong> &nbsp;
						<?php if($this->tempVars['SubmissionList'][0]->submission_creativity !='0')
						{
							echo $this->tempVars['SubmissionList'][0]->submission_creativity;
						}
						?>
					</td>		
					<td>
						<strong>Design:</strong> &nbsp;
						<?php if($this->tempVars['SubmissionList'][0]->submission_design !='0')
						{
							echo $this->tempVars['SubmissionList'][0]->submission_design; 
						}
						?>
					</td>
					<td>
						<strong>Fonts:</strong> &nbsp;
						<?php if($this->tempVars['SubmissionList'][0]->submission_fonts !='0')
						{
							echo $this->tempVars['SubmissionList'][0]->submission_fonts; 
						}
						?>
					</td>	
					<td>
						<strong>Colors:</strong> &nbsp;
						<?php if($this->tempVars['SubmissionList'][0]->submission_colors !='0')
						{
							echo $this->tempVars['SubmissionList'][0]->submission_colors; 
						}
						?>
					</td>	
				</tr>
